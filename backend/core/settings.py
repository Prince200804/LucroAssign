...
MIDDLEWARE = [
    ...
    'analytics.middleware.InteractionTrackingMiddleware',
]
...
FRONTEND_URL = os.environ.get('FRONTEND_URL', '').rstrip('/')  # Remove trailing slash
if FRONTEND_URL:
...
# Stripe Settings
# Sign up at https://stripe.com to get your keys
